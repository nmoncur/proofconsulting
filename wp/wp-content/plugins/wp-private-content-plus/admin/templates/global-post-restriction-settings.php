<?php 
    ...
    if(isset($restrict_all_posts_status)){
        $checked_restrict_all_posts_status_status = checked( '1', $restrict_all_posts_status, false );
    }
...
<table class="form-table wppcp-settings-list">
                <tr>
                    ...
                    <td style="width:500px;">
                        <input type="checkbox" name="wppcp_global_post_restriction[restrict_all_posts_status]" <?php echo $checked_restrict_all_posts_status_status; ?> value="1" /><br/>
