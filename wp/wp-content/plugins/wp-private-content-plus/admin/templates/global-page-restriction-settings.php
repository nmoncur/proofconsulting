<?php 
    ...
    if(isset($restrict_all_pages_status)){
        $checked_restrict_all_pages_status_status = checked( '1', $restrict_all_pages_status, false );
    }
...
<table class="form-table wppcp-settings-list">
                <tr>
                    ...
                    <td style="width:500px;">
                        <input type="checkbox" name="wppcp_global_page_restriction[restrict_all_pages_status]" <?php echo $checked_restrict_all_pages_status_status; ?> value="1" /><br/>
